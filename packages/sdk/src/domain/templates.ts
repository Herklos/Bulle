...
const LAYETTE: ProjectTemplate = {
  ...
  tasks: [
    ...
    {
      titleKey: 'templates.layette.tasks.tetines',
      notesKey: 'templates.layette.tasks.tetinesNote',
      detailsKey: 'templates.layette.tasks.tetinesDetails',
      weekStart: 30,
      weekEnd: 38,
      effort: 'S',
      domain: 'achats',
    ...
    {
      titleKey: 'templates.layette.tasks.coussinets',
      notesKey: 'templates.layette.tasks.coussinetsNote',
      detailsKey: 'templates.layette.tasks.coussinetsDetails',
      weekStart: 32,
      weekEnd: 39,
      effort: 'S',
      domain: 'postpartum',
    ...
    {
      titleKey: 'templates.layette.tasks.moufles',
      detailsKey: 'templates.layette.tasks.mouflesDetails',
      weekStart: 30,
      weekEnd: 38,
      effort: 'S',
      domain: 'achats',
